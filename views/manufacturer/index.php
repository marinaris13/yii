...
$this->title = Yii::t('app', 'Изготовители');
?>

<?php
$this->registerJs('            
            $("#new_manufacturer").on("pjax:end", function() {
...
<div>
    ...
    <div style="margin-bottom: 20px;" class="clearfix">
        ...
        <?php
        Modal::begin([
            'header'       => '<h2>Добавить изготовителя!</h2>',
            'id'           => 'modal_add',
            'toggleButton' => [
                'tag'   => 'button',
                'class' => 'btn btn-info pull-right',
                'label' => '+ Добавить изготовителя',
            ]
        ]);
        ?>
        <?php Pjax::begin(['id' => 'new_manufacturer']); ?>
    ...
    <?php Pjax::begin(['id' => 'manufacturers']); ?>
    ...
    GridView::widget([
        ...
        'columns'      => [  // задаем колонки
            ...
            <?php
            Modal::begin([
                'header' => '<h2>Редактировать изготовителя!</h2>',
                'id'     => 'modal_edit',
            ]);
            ?>
            <div class="form-edit">
...
<script>
    function update_data(elementId) {
        $.get("/index.php?r=manufacturer%2Fget&id=" + elementId, function (data) {
            $(".form-edit").html(data);
